        ...
        <div class="row">
             ...
             <div class="col-lg-7 mx-auto col-md-10 col-12">
                  <div class="about-info">
                       ...
                       <p class="mb-0" data-aos="fade-up">Total 5 HTML pages are included in this template from TemplateMo website. Please check 2 <a href="{{route('blog')}}">blog</a> pages, <a href="{{route('project-detail')}}">project</a> page, and <a href="{{route('contact')}}">contact</a> page. 
