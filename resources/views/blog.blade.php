              ...
              <div class="col-lg-7 col-md-7 col-12 mb-4">
                <div class="blog-header" data-aos="fade-up" data-aos-delay="100">
                  ...
                  <div class="blog-header-info">
                    ...
                    <h3><a href="{{route('blog-detail')}}">The Key to Creative Work is Knowing When to Walk Away</a></h3>
                  </div>
                </div>
              </div>
              ...
              <div class="col-lg-5 col-md-5 col-12 mb-4">
                <div class="blog-sidebar d-flex justify-content-center align-items-center" data-aos="fade-up" data-aos-delay="200">
                  ...
                  <div class="blog-info">
                    ...
                    <h3><a href="{{route('blog-detail')}}">Why Truly Accessible Design Benefits Everyone</a></h3>
                  </div>
                </div>
                ...
                <div class="blog-sidebar py-4 d-flex justify-content-center align-items-center" data-aos="fade-up" data-aos-delay="300">
                  ...
                  <div class="blog-info">
                    ...
                    <h3><a href="{{route('blog-detail')}}">Be Humble About What You Know</a></h3>
                  </div>
                </div>
                ...
                <div class="blog-sidebar d-flex justify-content-center align-items-center" data-aos="fade-up" data-aos-delay="200">
                  ...
                  <div class="blog-info">
                    ...
                    <h3><a href="{{route('blog-detail')}}">The Mistakes I Made As a Coding Beginner</a></h3>
                  </div>
                </div>
