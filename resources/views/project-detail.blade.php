...
<div class="full-image text-center" data-aos="zoom-in">
 <img src="{{asset('images/project/project-detail/interview-process.jpg')}}" class="img-fluid" alt="interview process">
</div>
    ...
    <div class="container">
         <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-12 mb-5">
                ...
                <img src="{{asset('images/project/project-detail/interview-process.jpg')}}images/project/project-detail/personal-website.png" class="img-fluid" alt="personal website" data-aos="fade-up">
              </div>
